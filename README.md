# image-build-cilium-operator-generic

This repo builds a hardened image for the Cilium `operator-generic` component that
...
- `cwayne18/hardened-cilium-operator-generic`
